...
enum ts_symbol_identifiers {
  ...
  sym_import = 55,
  sym_import_path = 56,
  sym__import_path_part = 57,
  sym_import_path_group = 58,
  sym_parameter_list = 59,
  sym_parameter = 60,
  sym_filtermap_item = 61,
  ...
  aux_sym_import_path_group_repeat1 = 99,
...
static const uint32_t ts_small_parse_table_map[] = {
  ...
  [SMALL_STATE(116)] = 5931,
  [SMALL_STATE(117)] = 5968,
  [SMALL_STATE(118)] = 6007,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [89] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0), SHIFT_REPEAT(43),
  ...
  [107] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0), SHIFT_REPEAT(59),
  ...
  [193] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__literal, 1, 0, 0),
  [195] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__literal, 1, 0, 0),
  ...
  [213] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parentheses_expression, 3, 0, 0),
  [215] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_parentheses_expression, 3, 0, 0),
  [217] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_not_expression, 2, 0, 0),
  [219] = {.entry = {.count = 1, .reusable = true}}, SHIFT(254),
  [221] = {.entry = {.count = 1, .reusable = true}}, SHIFT(15),
  [223] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_not_expression, 2, 0, 0),
  [225] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call_expression, 5, 0, 8),
  [227] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_call_expression, 5, 0, 8),
  [229] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_question_expression, 2, 0, 0),
  [231] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_question_expression, 2, 0, 0),
  ...
  [237] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_access_expression, 3, 0, 0),
  [239] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_access_expression, 3, 0, 0),
  [241] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call_expression, 3, 0, 8),
  [243] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_call_expression, 3, 0, 8),
  [245] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binary_expression, 3, 0, 9),
  [247] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_binary_expression, 3, 0, 9),
  [249] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_typed_record_expression, 2, 0, 0),
  [251] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_typed_record_expression, 2, 0, 0),
  [253] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record_expression, 4, 0, 0),
  [255] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_record_expression, 4, 0, 0),
  [257] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record_expression, 2, 0, 0),
  [259] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_record_expression, 2, 0, 0),
  [261] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call_expression, 4, 0, 8),
  [263] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_call_expression, 4, 0, 8),
  [265] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_return_expression, 2, 0, 0),
  ...
  [279] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_negation_expression, 2, 0, 0),
  [281] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_negation_expression, 2, 0, 0),
  [283] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_let_statement, 5, 0, 10),
  [285] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_let_statement, 5, 0, 10),
  [287] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_import, 3, 0, 0),
  [289] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import, 3, 0, 0),
  ...
  [295] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_let_statement, 7, 0, 13),
  [297] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_let_statement, 7, 0, 13),
  [299] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__statement, 2, 0, 0),
  [301] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__statement, 2, 0, 0),
  ...
  [313] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_last_match_arm, 5, 0, 15),
  ...
  [331] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__expression, 1, 0, 0), SHIFT(162),
  [334] = {.entry = {.count = 1, .reusable = true}}, SHIFT(213),
  [336] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_last_match_arm, 3, 0, 12),
  [338] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_call_expression_repeat1, 2, 0, 0),
  [340] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record_field, 3, 0, 0),
  ...
  [551] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_call_expression_repeat1, 2, 0, 0), SHIFT_REPEAT(39),
