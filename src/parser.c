...
enum ts_symbol_identifiers {
  ...
  sym_import = 62,
  sym_import_path = 63,
  sym__import_path_part = 64,
  sym_import_path_group = 65,
  sym_parameter_list = 66,
  sym_parameter = 67,
  sym_filtermap_item = 68,
  sym_function_item = 69,
  sym_test_item = 70,
  sym_enum_item = 71,
  sym_enum_constructors = 72,
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 25:
      ...
      if (set_contains(sym_identifier_character_set_3, 800, lookahead)) ADVANCE(30);
      END_STATE();
    case 26:
      ACCEPT_TOKEN(sym_identifier);
      if (lookahead == ':') ADVANCE(13);
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [STATE(2)] = {
    ...
    [sym_question_expression] = STATE(74),
    [sym_return_expression] = STATE(74),
    [sym_negation_expression] = STATE(74),
    [sym_not_expression] = STATE(74),
    [sym_binary_expression] = STATE(74),
    [sym_if_else_expression] = STATE(74),
    [sym_while_expression] = STATE(74),
    [sym_for_expression] = STATE(74),
    [sym_match_expression] = STATE(74),
    [sym_access_expression] = STATE(74),
    [sym_call_expression] = STATE(74),
    [sym_parentheses_expression] = STATE(74),
    [sym_typed_record_expression] = STATE(74),
...
static const uint32_t ts_small_parse_table_map[] = {
  ...
  [SMALL_STATE(157)] = 7912,
  [SMALL_STATE(158)] = 7931,
  [SMALL_STATE(159)] = 7950,
  [SMALL_STATE(160)] = 7969,
  [SMALL_STATE(161)] = 7988,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [74] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0), SHIFT_REPEAT(174),
  [77] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0), SHIFT_REPEAT(188),
  [80] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0),
  [82] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0), SHIFT_REPEAT(22),
  [85] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0), SHIFT_REPEAT(13),
  [88] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0), SHIFT_REPEAT(320),
  ...
  [112] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0), SHIFT_REPEAT(83),
  [115] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0), SHIFT_REPEAT(87),
  [118] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0), SHIFT_REPEAT(87),
  ...
  [145] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_match_expression, 3, 0, 11),
  [147] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_match_expression, 3, 0, 11),
  [149] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_while_expression, 3, 0, 10),
  [151] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_while_expression, 3, 0, 10),
  [153] = {.entry = {.count = 1, .reusable = true}}, SHIFT(293),
  [155] = {.entry = {.count = 1, .reusable = true}}, SHIFT(79),
  [157] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_match_block, 2, 0, 0),
  [159] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_match_block, 2, 0, 0),
  [161] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_match_block, 4, 0, 0),
  [163] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_match_block, 4, 0, 0),
  [165] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_if_else_expression, 5, 0, 17),
  [167] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_else_expression, 5, 0, 17),
  [169] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_match_block, 3, 0, 0),
  [171] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_match_block, 3, 0, 0),
  ...
  [209] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_let_statement, 5, 0, 16),
  [211] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_let_statement, 5, 0, 16),
  [213] = {.entry = {.count = 1, .reusable = true}}, SHIFT(206),
  [215] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__statement, 2, 0, 0),
  [217] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__statement, 2, 0, 0),
  [219] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_let_statement, 7, 0, 22),
  [221] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_let_statement, 7, 0, 22),
  [223] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_import, 3, 0, 0),
  [225] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import, 3, 0, 0),
  [227] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_block_repeat1, 1, 0, 0),
  [229] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_block_repeat1, 1, 0, 0),
  [231] = {.entry = {.count = 1, .reusable = true}}, SHIFT(312),
  [233] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call_expression, 5, 0, 12),
  [235] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_call_expression, 5, 0, 12),
  [237] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_list_expression, 5, 0, 0),
  [239] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_list_expression, 5, 0, 0),
  [241] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call_expression, 4, 0, 12),
  [243] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_call_expression, 4, 0, 12),
  [245] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_list_expression, 2, 0, 0),
  [247] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_list_expression, 2, 0, 0),
  [249] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record_expression, 5, 0, 0),
  [251] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_record_expression, 5, 0, 0),
  [253] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_typed_record_expression, 2, 0, 0),
  [255] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_typed_record_expression, 2, 0, 0),
  [257] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_for_expression, 5, 0, 18),
  [259] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_for_expression, 5, 0, 18),
  ...
  [269] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_access_expression, 3, 0, 0),
  [271] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_access_expression, 3, 0, 0),
  [273] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call_expression, 3, 0, 12),
  [275] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_call_expression, 3, 0, 12),
  [277] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call_expression, 6, 0, 12),
  [279] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_call_expression, 6, 0, 12),
  [281] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binary_expression, 3, 0, 13),
  [283] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_binary_expression, 3, 0, 13),
  ...
  [293] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_question_expression, 2, 0, 0),
  [295] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_question_expression, 2, 0, 0),
  ...
  [301] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record_expression, 2, 0, 0),
  [303] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_record_expression, 2, 0, 0),
  [305] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__literal, 1, 0, 0),
  [307] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__literal, 1, 0, 0),
  [309] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record_expression, 3, 0, 0),
  [311] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_record_expression, 3, 0, 0),
  ...
  [317] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_list_expression, 3, 0, 0),
  [319] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_list_expression, 3, 0, 0),
  [321] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_unit_literal, 2, 0, 0),
  [323] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_unit_literal, 2, 0, 0),
  ...
  [337] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_return_expression, 2, 0, 0),
  [339] = {.entry = {.count = 1, .reusable = true}}, SHIFT(50),
  [341] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_negation_expression, 2, 0, 0),
  [343] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_negation_expression, 2, 0, 0),
  ...
  [377] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__expression, 1, 0, 0), SHIFT(188),
  [380] = {.entry = {.count = 1, .reusable = true}}, SHIFT(316),
  [382] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_last_match_arm, 3, 0, 20),
  [384] = {.entry = {.count = 1, .reusable = true}}, SHIFT(162),
  [386] = {.entry = {.count = 1, .reusable = true}}, SHIFT(291),
  [388] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_last_match_arm, 5, 0, 24),
  [390] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record_field, 3, 0, 0),
  ...
  [400] = {.entry = {.count = 1, .reusable = true}}, SHIFT(281),
  ...
  [412] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(179),
  [415] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(285),
  [418] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(285),
  [421] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(309),
  [424] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(310),
  [427] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(304),
  ...
  [443] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record_type, 3, 0, 0),
  ...
  [457] = {.entry = {.count = 1, .reusable = true}}, SHIFT(277),
  ...
  [481] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_filtermap_item, 4, 0, 4),
  [483] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_filtermap_item, 4, 0, 4),
  ...
  [497] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_enum_constructors, 2, 0, 0),
  [499] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_enum_constructors, 2, 0, 0),
  ...
  [509] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_enum_item, 3, 0, 2),
  [511] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_enum_item, 3, 0, 2),
  [513] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_item, 4, 0, 4),
  [515] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_function_item, 4, 0, 4),
  [517] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_item, 6, 0, 8),
  [519] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_function_item, 6, 0, 8),
  [521] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_test_item, 3, 0, 1),
  [523] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_test_item, 3, 0, 1),
  [525] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record_item, 3, 0, 3),
  [527] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_record_item, 3, 0, 3),
  [529] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_enum_constructors, 3, 0, 0),
  [531] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_enum_constructors, 3, 0, 0),
  [533] = {.entry = {.count = 1, .reusable = true}}, SHIFT(17),
  [535] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type_name, 3, 0, 0),
  ...
  [547] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pattern, 1, 0, 0),
  [549] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__type, 1, 0, 0),
  [551] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type_name, 5, 0, 0),
  [553] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type_name, 4, 0, 0),
  [555] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type_name, 6, 0, 0),
  [557] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_optional_type, 2, 0, 0),
  [559] = {.entry = {.count = 1, .reusable = true}}, SHIFT(204),
  [561] = {.entry = {.count = 1, .reusable = true}}, SHIFT(198),
  [563] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import_path, 2, 0, 0),
  [565] = {.entry = {.count = 1, .reusable = true}}, SHIFT(205),
  [567] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import_path, 1, 0, 0),
  [569] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_match_block_repeat1, 2, 0, 0), SHIFT_REPEAT(60),
  [572] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_import_path_repeat1, 2, 0, 0),
  [574] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_import_path_repeat1, 2, 0, 0), SHIFT_REPEAT(205),
  [577] = {.entry = {.count = 1, .reusable = true}}, SHIFT(189),
  [579] = {.entry = {.count = 1, .reusable = true}}, SHIFT(217),
  [581] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_type_parameters_repeat1, 2, 0, 0), SHIFT_REPEAT(288),
  ...
  [592] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_enum_constructor_repeat1, 2, 0, 0), SHIFT_REPEAT(145),
  [595] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_enum_constructor_repeat1, 2, 0, 0),
  ...
  [605] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pattern_arguments, 2, 0, 0),
  ...
  [633] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pattern_arguments, 4, 0, 0),
  [635] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pattern, 2, 0, 0),
  [637] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pattern_arguments, 5, 0, 0),
  [639] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import_path_group, 3, 0, 0),
  [641] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import_path_group, 4, 0, 0),
  [643] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_call_expression_repeat1, 2, 0, 0), SHIFT_REPEAT(52),
  [646] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import_path_group, 2, 0, 0),
  [648] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__import_path_part, 1, 0, 0),
  [650] = {.entry = {.count = 1, .reusable = true}}, SHIFT(140),
  [652] = {.entry = {.count = 1, .reusable = true}}, SHIFT(257),
  [654] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import_path_group, 5, 0, 0),
  ...
  [662] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_record_type_repeat1, 2, 0, 0), SHIFT_REPEAT(267),
  [665] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_record_type_repeat1, 2, 0, 0),
  ...
  [701] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_record_expression_repeat1, 2, 0, 0), SHIFT_REPEAT(272),
  [704] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_record_expression_repeat1, 2, 0, 0),
  ...
  [736] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_enum_constructors_repeat1, 2, 0, 0), SHIFT_REPEAT(261),
  [739] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_enum_constructors_repeat1, 2, 0, 0),
  ...
  [751] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record_type_field, 3, 0, 0),
  [753] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter, 3, 0, 0),
  [755] = {.entry = {.count = 1, .reusable = true}}, SHIFT(216),
  [757] = {.entry = {.count = 1, .reusable = true}}, SHIFT(88),
  [759] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_enum_constructor, 1, 0, 5),
  [761] = {.entry = {.count = 1, .reusable = true}}, SHIFT(135),
  [763] = {.entry = {.count = 1, .reusable = true}}, SHIFT(269),
  [765] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_parameter_list_repeat1, 2, 0, 0), SHIFT_REPEAT(270),
  [768] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_parameter_list_repeat1, 2, 0, 0),
  [770] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_import_path_group_repeat1, 2, 0, 0), SHIFT_REPEAT(180),
  [773] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_import_path_group_repeat1, 2, 0, 0),
  [775] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_enum_constructor, 5, 0, 19),
  [777] = {.entry = {.count = 1, .reusable = true}}, SHIFT(141),
  [779] = {.entry = {.count = 1, .reusable = true}}, SHIFT(38),
  [781] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_match_arm, 3, 0, 20),
  [783] = {.entry = {.count = 1, .reusable = true}}, SHIFT(235),
  [785] = {.entry = {.count = 1, .reusable = true}}, SHIFT(283),
  [787] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_enum_constructor, 6, 0, 21),
  [789] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_enum_constructor, 4, 0, 15),
  [791] = {.entry = {.count = 1, .reusable = true}}, SHIFT(31),
  [793] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_match_arm, 5, 0, 24),
  ...
  [801] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter_list, 3, 0, 0),
  [803] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_enum_constructor, 3, 0, 14),
  [805] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter_list, 4, 0, 0),
  [807] = {.entry = {.count = 1, .reusable = true}}, SHIFT(196),
  [809] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_match_arm, 6, 0, 25),
  [811] = {.entry = {.count = 1, .reusable = true}}, SHIFT(144),
  [813] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type_parameters, 5, 0, 0),
  ...
  [821] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_match_block_repeat1, 1, 0, 0),
  [823] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_last_match_arm, 6, 0, 25),
  ...
  [833] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_match_arm, 4, 0, 23),
  [835] = {.entry = {.count = 1, .reusable = true}}, SHIFT(190),
  [837] = {.entry = {.count = 1, .reusable = true}}, SHIFT(181),
  [839] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type_parameters, 3, 0, 0),
  [841] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type_parameters, 2, 0, 0),
  ...
  [857] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_last_match_arm, 4, 0, 23),
  [859] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type_parameters, 4, 0, 0),
